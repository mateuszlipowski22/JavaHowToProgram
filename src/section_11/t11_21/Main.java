...
public class Main {
    ...
    public static void someMethod1() throws Exception {
        try {
            ...
            System.out.println("Obsługa wyjątku w metodzie someMethod1()");
            throw new Exception("Błąd podczas wykonywania metody someMethod2()", exception);
        }
    }
